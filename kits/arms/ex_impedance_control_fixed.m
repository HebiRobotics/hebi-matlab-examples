...
% 
% The following example is the 'Fixed' demo.
...
arm = HebiArm.createFromConfig('config/ex_impedance_control_fixed.cfg.yaml');
...
disp('          ON  - Apply controller based on current position and orientation');
