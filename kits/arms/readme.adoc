...
{assembly}/R-Series_6-DoF_Arm.pdf[Assembly Instructions]|
{kitimg}/R-6-DoF_Arm.png[{imgsize}]

|`'5dof'`|`'R-Series'`|A-2084-05|
5 - DoF R-Series Arm Kit +
{assembly}/R-Series_5-DoF_Arm.pdf[Assembly Instructions]|
{kitimg}/R-5-DoF_Arm.png[{imgsize}]

|`'4dof'`|`'R-Series'`|A-2084-04|
4 - DoF R-Series Arm Kit +
{assembly}/R-Series_4-DoF_Arm.pdf[Assembly Instructions]|
{kitimg}/R-4-DoF_Arm.png[{imgsize}]
