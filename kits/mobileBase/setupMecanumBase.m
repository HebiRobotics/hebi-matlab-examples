...
wheelRadius = 0.0508;  % [m]
wheelBase = 0.40; % [m] distance between left and right wheels
wheelBaseLength = 0.400; % [m] distance bewteen front and rear wheels
...
params.maxLinSpeed = 50 * (1/60) * 2*pi*wheelRadius; % m/s (Limited to half of actual = 0.8 m/s )
...
params.wheelModuleNames = { 'W1_frontLeft', ...
                            'W2_backLeft', ...
                            'W3_frontRight', ...
                            'W4_backRight' };
params.numWheels = 4;
