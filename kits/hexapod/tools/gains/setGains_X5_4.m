 function [ gains ] = setGains_X5_4( gainGroup )
    ...
    gains.velocityKp = ones(1, numModules) * 0.10;
    ...
    gains.velocityKp = ones(1, numModules) * .2;
    gains.velocityKi = ones(1, numModules) * .02;
    gains.velocityIClamp = ones(1, numModules) * 2.0;
    gains.velocityKd = ones(1, numModules) * 0.0;
