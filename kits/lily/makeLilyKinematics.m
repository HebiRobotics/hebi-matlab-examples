...
chassisKin = HebiKinematics([localDir '/hrdf/LilyChassis.hrdf']);
...
for leg=1:6
    if rem(leg,2)==1
        legKin{leg} = HebiKinematics([localDir '/hrdf/lilyLeg-Left.hrdf']);
    else    
        legKin{leg} = HebiKinematics([localDir '/hrdf/lilyLeg-Right.hrdf']);
    end
