...
wheelTransform = [ sin(a1) -cos(a1)  wheelBase;   % Front Right (_Wheel1)
                   sin(a2) -cos(a2)  wheelBase;   % Front Left (_Wheel2)
                   sin(a3) -cos(a3)  wheelBase ]; % Rear (_Wheel3)
