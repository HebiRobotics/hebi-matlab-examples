...
for leg = 1:numLegs
    legKin{leg} = HebiKinematics([localDir '/hrdf/igorLeg.hrdf']);
...
armKin{1} = HebiKinematics([localDir '/hrdf/igorArm-Left.hrdf']);
armKin{2} = HebiKinematics([localDir '/hrdf/igorArm-Right.hrdf']);
...
% Chassis Kinematics %
%%%%%%%%%%%%%%%%%%%%%%
chassisKin = HebiKinematics([localDir '/hrdf/igorChassis.hrdf']);