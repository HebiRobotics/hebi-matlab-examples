 function [ gains ] = setGains_X8_3( gainGroup )
...
%                             gains.torqueKp .* gains.torqueDeadZone;
    ...
    gains.torqueOutputLowpassGain = ones(1, numModules) * .9;
    ...
    % Position ( rad ---> N-m )
    gains.positionKp = ones(1, numModules) * 3;
