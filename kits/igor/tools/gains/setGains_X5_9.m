 function [ gains ] = setGains_X5_9( gainGroup )
    ...
    % Position ( rad ---> PWM )
    gains.positionKp = ones(1, numModules) * 1.5;
    ...
    gains.velocityKp = ones(1, numModules) * .10;
    ...
    gains.velocityOutputLowpassGain = ones(1, numModules) * .75;
    ...
    gains.torqueKd = ones(1, numModules) * 0.0;
    ...
    % Position ( rad ---> N-m )
    gains.positionKp = ones(1, numModules) * 15;
