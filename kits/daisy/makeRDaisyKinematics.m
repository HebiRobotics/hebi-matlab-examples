function [ legKin, chassisKin ] = makeRDaisyKinematics( )
...
chassisKin = HebiKinematics([localDir '/hrdf/RdaisyChassis.hrdf']);
...
for leg=1:6
    if rem(leg,2)==1
        legKin{leg} = HebiKinematics([localDir '/hrdf/RdaisyLeg-Left.hrdf']);
    else    
        legKin{leg} = HebiKinematics([localDir '/hrdf/RdaisyLeg-Right.hrdf']);
    end
