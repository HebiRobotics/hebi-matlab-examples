...
The examples provided here work progressively through concepts that are documented in more detail at:
...
This will add the various folder paths and libraries to the MATLAB search path so that the API works correctly.
