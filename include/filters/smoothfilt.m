function [ smoothData ] = smoothfilt( inputData, windowSize )
%SMOOTHFILT Takes in a vector of data and smooths it with a rolling-window
%of a specified size.  It does this with zero-lag, looking forward and
%backwards in the vector.
    ...
    for i=1:dataLength
        ...
        smoothData(i) = mean( inputData(bwdIndex:fwdIndex) );
    end
